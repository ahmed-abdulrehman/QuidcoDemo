...
public class Utility {
	...
	public static String captureScreenshot(WebDriver driver, String screenshotName) {
		try {
			...
			dest = "../APK_Report/Screenshots/" + screenshotName + ".png";
	...
	public void startReport() {
		path = "../APK_Report/TestResults.html";
		report = new ExtentReports(path, true);
		report.loadConfig(new File("../QuidcoAPK/extent-config.xml"));// new
	}
	...
	public void openReport() {
		driver.get("../APK_Report/TestResults.html");
	}
